 ...
 *
 *   // network
 *   CZCoreNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.zcore.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CZCoreNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: ZCoreNetwork
// //   -- signature requirements : Key1(User)
// class CZCoreNetworkVariable : public CGovernanceObject
// {
// private:
