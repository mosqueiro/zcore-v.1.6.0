...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "ZCoreNetwork") type = ZCoreNetwork;
    if(strType == "ZCoreNetworkVariable") type = ZCoreNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == ZCoreNetwork) s = "ZCoreNetwork";
    if(type == ZCoreNetworkVariable) s = "ZCoreNetworkVariable";
