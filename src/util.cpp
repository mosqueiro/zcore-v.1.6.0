...
const char * const BITCOIN_CONF_FILENAME = "zcore.conf";
const char * const BITCOIN_PID_FILENAME = "zcored.pid";
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\ZCoreCore
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\ZCoreCore
    // Mac: ~/Library/Application Support/ZCoreCore
    // Unix: ~/.zcore
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "ZCoreCore";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/ZCoreCore";
#else
    // Unix
    return pathRet / ".zcore";
#endif
#endif
}
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()){
        // Create empty zcore.conf if it does not excist
