...
All the ZCore in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 ZCR, 0.1 ZCR, 1 ZCR and 10 ZCR -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://zcorecoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://zcorecoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
