...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About ZCore"), this);
    ...
    showHelpMessageAction->setStatusTip(tr("Show the ZCore help message to get a list with possible ZCore command-line options"));
