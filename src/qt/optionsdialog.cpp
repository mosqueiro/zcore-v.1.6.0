    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("ZCR-light"), QVariant("light"));
    ui->theme->addItem(QString("ZCR-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("ZCR-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("ZCR-traditional"), QVariant("trad"));
